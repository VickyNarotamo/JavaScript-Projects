...
function placeXOrO(squareNumber) {
    // This condition ensures is used to check each element of selectedSquare array to
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            document.getElementById(squareNumber).style.backgroundImage = 'url("images/x.png")';
        } else {
            // If activePlayer is equal to 'O' the o.png is placed in HTML.
            document.getElementById(squareNumber).style.backgroundImage = 'url("images/o.png")';
        }
    ...
    // Returning false if the square is already selected.
    return false;
}
